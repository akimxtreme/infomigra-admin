...
class DaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create day" do
    assert_difference('Day.count') do
      post days_url, params: { day: { abbreviation: @day.abbreviation, description: @day.description, name: @day.name } }
    end
  ...
  test "should update day" do
    patch day_url(@day), params: { day: { abbreviation: @day.abbreviation, description: @day.description, name: @day.name } }
