...
class StudiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create study" do
    assert_difference('Study.count') do
      post studies_url, params: { study: { description: @study.description, name: @study.name } }
    end
  ...
  test "should update study" do
    patch study_url(@study), params: { study: { description: @study.description, name: @study.name } }
