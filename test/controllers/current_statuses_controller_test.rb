...
class CurrentStatusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create current_status" do
    assert_difference('CurrentStatus.count') do
      post current_statuses_url, params: { current_status: { description: @current_status.description, name: @current_status.name, percentage_profile: @current_status.percentage_profile } }
    end
  ...
  test "should update current_status" do
    patch current_status_url(@current_status), params: { current_status: { description: @current_status.description, name: @current_status.name, percentage_profile: @current_status.percentage_profile } }
