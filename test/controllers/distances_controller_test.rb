...
class DistancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create distance" do
    assert_difference('Distance.count') do
      post distances_url, params: { distance: { description: @distance.description, kilometers: @distance.kilometers, name: @distance.name } }
    end
  ...
  test "should update distance" do
    patch distance_url(@distance), params: { distance: { description: @distance.description, kilometers: @distance.kilometers, name: @distance.name } }
