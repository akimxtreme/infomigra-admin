...
class InterestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create interest" do
    assert_difference('Interest.count') do
      post interests_url, params: { interest: { description: @interest.description, name: @interest.name } }
    end
  ...
  test "should update interest" do
    patch interest_url(@interest), params: { interest: { description: @interest.description, name: @interest.name } }
